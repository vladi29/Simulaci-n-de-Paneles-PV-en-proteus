...
int Timer2, PostCaler, duty; // Preescaler;
...
void main(){
    ...
    Timer2 = 49;                                     //Para este valor del Timer se puede alcanzar una f=5KHz
    PostCaler = 1;
    duty = 100;// Sólo puede tomar valores de 1, 4 o 16, igual que el preescaler
    //Preescaler = 4;
    ...
    while(1){
       ...
       set_pwm1_duty(100);         //Se confiugura el dutycycle de la PWM 
